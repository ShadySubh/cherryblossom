...
const navLinks = [
  ...
  { label: 'GitHub', href: 'https://github.com/ShadySubh/', external: true },
];
...
const CONTACT_EMAIL = 'shadysubh@gmail.com';
const WHATSAPP_URL = 'https://wa.me/919954168934';
  ...
  return (
    <>
      ...
      <div className="col">
        ...
        {/* ── Navbar ─────────────────────────── */}
        <nav className="nav">
          <img src={diaCover} alt="Shibu D." className="nav-logo-img" />
          <div className="nav-links">
            ...
            <a href={WHATSAPP_URL} className="nav-link" target="_blank" rel="noreferrer">
              WhatsApp
            </a>
        ...
        <div className="cover">
          ...
          <span className="cover-svg-wrap">
            <img src={diaCover} alt="Shibu D." className="cover-svg" loading="eager" />
          </span>
        </div>
        ...
        <section className="profile fade-up d1">
          <div className="avatar-wrap">
            <div className="avatar-inner">
              <img src={pfp} alt="Shibu D.'s profile picture" loading="eager" />
            </div>
          </div>

          <div className="profile-name fade-up d2">
            Shibu D. <VerifiedBadge />
          </div>
          ...
          <div className="cta-row fade-up">
            ...
            <div className="cta-video" aria-hidden="true">
              <img src={cuteGif} alt="Cute animation" />
            </div>
          </div>
        </section>
          ...
          <div className="cards stagger">
            {projects.map(p => (
              <Reveal key={p.title} variant="up" className="card">
                <a href={p.href} target="_blank" rel="noreferrer" className="card-img" style={{ display: 'block' }}>
                  {p.img
                ...
                <div className="card-header">
                  <a href={p.href} target="_blank" rel="noreferrer" className="card-title" style={{ color: 'inherit', textDecoration: 'none' }}>{p.title}</a>
        ...
        <section className="section" id="contact">
          ...
          <Reveal variant="up" className="form" as="form"
            ...
            <div className="form-actions">
              ...
              <a href={WHATSAPP_URL} className="ig-dm-btn" target="_blank" rel="noreferrer">
                Message on WhatsApp
              </a>
            </div>
          </Reveal>
